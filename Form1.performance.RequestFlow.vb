...
#Region "Ethernet communication"
    ...
    Private lastLogScrollUtc As DateTime = DateTime.MinValue

    Private Sub log_window_ad_TextChanged(sender As Object, e As EventArgs) Handles log_window_ad.TextChanged
        Dim nowUtc = DateTime.UtcNow
        If lastLogScrollUtc <> DateTime.MinValue AndAlso (nowUtc - lastLogScrollUtc).TotalMilliseconds < 250 Then
            Return
        End If

        lastLogScrollUtc = nowUtc
