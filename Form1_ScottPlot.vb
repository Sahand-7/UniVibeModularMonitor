...
Public Class Form1
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ' ScottPlot initialization (requires a FormsPlot named FormsPlot1 in the designer)
        InitializeScottPlot()
    End Sub
...
#End Region
    ...
    Private Sub FormsPlot1_Click(sender As Object, e As EventArgs)

    End Sub

    ''' <summary>
    ''' Call this once after InitializeComponent() or from Form1_Load after the FormsPlot
    ''' control has been created in the designer.
    ''' </summary>
    Private Sub InitializeScottPlot()
        If FormsPlot1 Is Nothing Then Return

        FormsPlot1.Reset()
        FormsPlot1.Plot.Title("Live Data")
